...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        CrudService crudService = new CrudService(connection);
        ...
        Spark.get(
                ...
                (request, response) -> {
                    ...
                    ArrayList userGroceryItems = crudService.selectEntries(connection, user.getId());
        ...
        Spark.post(
                ...
                (request, response) -> {
                    ...
                    item.setName(request.queryParams("name"));
                   ...
                   crudService.insertEntry(connection, item);
        ...
        Spark.post(
                ...
                (request, response) -> {
                    ...
                    crudService.updateEntry(connection, newGroceryItem);
        ...
        Spark.get(
                ...
                (request, response) -> {
                    ...
                    crudService.deleteEntry(connection, item);
    ...
    /*private static ArrayList<GroceryItem> getGroceryItems(User user) {
        ...
        ArrayList temp = crudService.selectEntries;
